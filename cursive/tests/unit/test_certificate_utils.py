...
class TestCertificateUtils(base.TestCase):
    ...
    def test_verify_valid_certificate(self, mock_get_cert):
    ...
    @mock.patch('cursive.signature_utils.get_certificate')
    def test_verify_invalid_certificate(self, mock_get_cert):
        ...
        self.assertRaisesRegex(
            ...
            "next signing certificate in the set of context certificates.",
            certificate_utils.verify_certificate,
            None,
            cert_uuid,
            trusted_cert_uuids
    ...
    @mock.patch('cursive.signature_utils.get_certificate')
    def test_verify_valid_certificate_with_no_root(self, mock_get_cert):
