    ...
    def verify(self):
        ...
        while True:
            ...
            for certificate_tuple in self._signing_certificates:
                ...
                # If issuer matching succeeds the candidate may be the parent
                # of the signed certificate, so move on to verifying the
                # certificate signature to confirm. Otherwise, skip this
                # candidate.
            ...
            for i in range(len(certificate_chain)):
                ...
                try:
                    ...
                    raise exception.SignatureVerificationError(
                        ...
                        "length." % certificate_chain_uuids[i]
                    )
