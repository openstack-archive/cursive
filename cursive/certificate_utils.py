...
def is_issuer(issuing_certificate, issued_certificate):
    ...
    Determine if the certificates' subject and issuer names match.
    ...
    :return: True if the issuing certificate's subject match the issued
             certificate's issuer, False otherwise.
    """
    ...
    def verify(self):
        ...
        while True:
            ...
            for certificate_tuple in self._signing_certificates:
                ...
                # Only consider candidates who pass the issuer check.
                if is_issuer(candidate, signed_certificate):
                    try:
                        # Verify that the candidate actually signed the
                        # certificate.
                        ...
                        # The candidate is the signing certificate, so stop
                        # searching.
            ...
            for i in range(len(certificate_chain)):
                ...
                try:
                    ...
                    raise exception.SignatureVerificationError(
                        ...
                        "extension." % certificate_chain_uuids[i]
                    )
